<div class="slideout-heading">
	...
	<div class="d-inline-block">	
		<h5 class="feat-movies-title-color"><?php the_field ('featured_movies_title', 'option') ; ?></h5>		
	</div>
	
	<?php if ( 1 == get_field('see_all_movies_button', 'option') ) : ?>		
	
		<?php 
		$link = get_field('all_movies_link', 'option');
		if( $link ): ?>
...
<?php $post_objects = get_field('select_featured_movies', 'option'); if( $post_objects ): ?>
